...
class task7_cprop extends CModule
{
    var $MODULE_ID  = 'task7.cprop';
    ...
    function getEvents()
    {
        return [
            ...
            ['HANDLER'=>'CustomTypeCProp','FROM_MODULE' => 'main', 'EVENT' => 'OnUserTypeBuildList', 'TO_METHOD' => 'GetUserTypeDescription'],
        ];
    }
